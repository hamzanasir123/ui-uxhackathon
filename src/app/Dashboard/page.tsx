...
export default function Home() {
  return (
    <div className="flex flex-col gap-5  w-full bg-white text-black">
      ...
      <section className="grid w-full grid-cols-1 gap-4 gap-x-8 p-10 transition-all sm:grid-cols-2 xl:grid-cols-4">
        {cardData.map((d, i) => (
          <Card
            key={i}
            amount={d.amount}
      ...
      <section className="grid grid-cols-1 p-10  gap-4 transition-all lg:grid-cols-2">
        <CardContent>
